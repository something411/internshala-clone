...
class SeniorSecondaryScreen extends StatefulWidget {
  @override
  _SeniorSecondaryScreenState createState() => _SeniorSecondaryScreenState();
}

class _SeniorSecondaryScreenState extends State<SeniorSecondaryScreen> {
  List<int> yearsOne = [];
  List<int> yearsTwo = [];
  int endYear;
  int groupValue;
